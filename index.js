...
app.get('/', (req, res) => {
  const htmlContent = `
    <h1>Welcome!</h1>
    <p>This is an example of how to make an API with Express and Node.js</p>
    <p>Main path to start: '/api/v1/'</p>
    <p>Made by Joaquin: <a href="https://github.com/forjoa/workers" target="_blank">GitHub Repo</a></p>
  `
